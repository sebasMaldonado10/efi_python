...
def register_routes(app):
    ...
    # ---- Posts ----
    app.add_url_rule("/api/posts",
                     view_func=PostListAPI.as_view("post_list"))
    app.add_url_rule("/api/posts/<int:post_id>",
                     view_func=PostDetailAPI.as_view("post_detail"))

    # ---- Comentarios ----
    app.add_url_rule("/api/posts/<int:post_id>/comments",
                     view_func=CommentListAPI.as_view("comment_list"))
    app.add_url_rule("/api/comments/<int:comment_id>",
                     view_func=CommentDeleteAPI.as_view("comment_delete"))

    # ---- Categorías ----
    app.add_url_rule("/api/categories",
                     view_func=CategoryListAPI.as_view("category_list"))
    app.add_url_rule("/api/categories/<int:category_id>",
    ...
    app.add_url_rule("/api/users/<int:user_id>",
                     view_func=UserDetailAPI.as_view("user_detail"))

    # ---- Stats ----
    app.add_url_rule("/api/stats",
                     view_func=StatsAPI.as_view("stats"))
